...
SQL*Plus: Release 21.0.0.0.0 - Production on 월 7월 14 14:30:56 2025
Version 21.3.0.0.0
...
SELECT * FROM HR.DEPARTMENTS;   -- 조회 실패
  ...
  ---------------------------------------------
ORACLE  의  TABLE 복사하기
HR 의 EMPLOYEES TABLE 복사해서 SKY 로 가져온다
...
3.  SQL SCRIPT  로 테이블 생성
 ...
 [2] 테이블 제거 - 영구적으로 구조와 데이터가 제거된다
    ...
    DROP TABLE EMP1;    
      -- drop 되는 테이블이 부모테이블일 경우 자식을 먼저 지워야 사게가능
